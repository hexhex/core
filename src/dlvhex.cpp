...
#warning reactivate dlvhdb
      ...
      case 28:
        pctx.config.setOption("BenchmarkEAstderr", 1);
        break;
      case 29:
        pctx.config.setOption("ExplicitFLPUnshift", 1);
        break;

      case 30:
        pctx.config.setOption("PrintLearnedNogoods", 1);
        break;

      case 31:
        pctx.config.setOption("NongroundNogoodInstantiation", 1);
        break;
      ...
      case 32: {
        ...
        pctx.config.setOption("ModelQueueSize", queuesize);
        break;
      ...
      case 34:
        pctx.config.setOption("MultiThreading", 1);
        break;

      case 35:
        pctx.config.setOption("FLPDecisionCriterion", 0);
        break;

      case 36:
        pctx.config.setStringOption("ClaspConfiguration", std::string(optarg));
        break;
