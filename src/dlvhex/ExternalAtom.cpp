...
// void
// ExternalAtom::setPluginAtom(const PluginContainer& container)
// {
...
// 	//
// 	this->pluginAtom = container.getAtom(functionName);
...
// void
// ExternalAtom::evaluate(const AtomSet& i, AtomSet& result) const
// {
//   assert(pluginAtom);
