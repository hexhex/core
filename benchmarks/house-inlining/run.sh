...
if [[ $all -eq 1 ]]; then
	...
	# run single instance
	confstr="houseGuess.hex;houseGuess.hex --supportsets;houseGuess.hex --extinlining;houseDirect.hex;houseGuess.hex -n=1;houseGuess.hex --supportsets -n=1;houseGuess.hex --extinlining -n=1;houseDirect.hex -n=1"
