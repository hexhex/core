...
if [[ $all -eq 1 ]]; then
	...
	# run single instance
	confstr="--extlearn --flpcheck=aufs --ufslearn=none --liberalsafety mergesort.hex -n=1;--extlearn --flpcheck=aufs --ufslearn=none --strongsafety mergesort_strongsafety.hex -n=1"
