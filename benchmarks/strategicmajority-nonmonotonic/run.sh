...
if [[ $all -eq 1 ]]; then
	...
	# run single instance
	confstr=";--eaevalheuristics=always --claspdefernprop=0; --ufslearnpartial --claspdefernprop=0; --ufslearnpartial --claspdefernprop=10; --ufslearnpartial --claspdefernprop=10000000"
