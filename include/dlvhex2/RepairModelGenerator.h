...
#ifndef REPAIR_MODEL_GENERATOR_HPP_INCLUDED__09122011
#define REPAIR_MODEL_GENERATOR_HPP_INCLUDED__09122011
...
class RepairModelGeneratorFactory:
  ...
  public ostream_printable<RepairModelGeneratorFactory>
{
  // types
public:
  ...
  public PropagatorCallback
{
  // types
public:
  typedef RepairModelGeneratorFactory Factory;
