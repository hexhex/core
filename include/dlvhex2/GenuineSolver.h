...
public:
	...
	static Ptr getInstance(ProgramCtx& ctx, OrdinaryASPProgram& program, bool interleavedThreading = true);
};
...
public:
	...
	static Ptr getInstance(ProgramCtx& ctx, OrdinaryASPProgram& p, bool interleavedThreading = true);
};
