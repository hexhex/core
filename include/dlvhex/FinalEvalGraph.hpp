...
{
  // TODO: storing it that way is easy but not nice, we SHOULD only store relevant information from ProgramCtx here in this local eval unit program ctx
  ProgramCtx& programCtx;
  ComponentGraph::ComponentInfo component;
};
