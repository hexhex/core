 ...
 * @date Sun Jul 06 11:51:42 CET 2008
 *
 * @brief 
 *
 *
...
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::DepGraphDirector(DGBuilder& b,
								PluginContainer& c)
  : builder(b),
    container(c)
{ }
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::constructHead(const RuleHead_t& head)
  throw (PluginError)
{
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::constructBody(const RuleHead_t& head)
  throw (PluginError)
{
  for (RuleBody_t::const_iterator li = body.begin(); li != body.end(); ++li)
    {
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(Program* const program)
{
  //
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(AtomSet* const)
{ }


template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(Rule* const r)
{
  //
  // go through entire head disjunction
  //
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(WeakConstraint* const)
{
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(Literal* const)
{
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(Atom* const)
{
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(ExternalAtom* const)
{
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(BuiltinPredicate* const)
{
...
template<class DepGraph, class Vertex, class VProp, class EProp>
void
DepGraphDirector<DepGraph,Vertex,VProp,EProp>::visit(AggregateAtom* const)
{
