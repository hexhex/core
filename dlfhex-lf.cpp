...
bool tom_ptr_less(const Atom* a, const Atom* b) {
	cout << "in" << endl;
...
struct ltstrn {
	bool operator()(const Rule* a, const Rule* b) const {
		Rule x(*a);
		Rule y(*b);
		 cout << "yay, i do not know if i will enter here" <<endl;
		 cout << a <<endl;
		 cout << b <<endl;
		return x != y;
	}
...
int main() {
	...
	Rule rule1;
	rule1.addHead(a);
	rule1.addPositiveBody(b);

	Rule rule2;
	rule2.addHead(b);
	rule2.addPositiveBody(a);
	...
	BridgeRule rule3;
	rule3.addHead(a);
	rule3.addPositiveBody(b_);

	BridgeRule rule4;
	rule4.addHead(b);
	rule4.addPositiveBody(a_);

	Context context1;
	context1.addRuleToKnowledgeBase(rule1);
	context1.addRuleToKnowledgeBase(rule2);
	context1.addRuleToBridgeRules(rule3);
	context1.addRuleToBridgeRules(rule4);
//	cout << "i am alive"<< endl;
	context1.createLocalDependcyGraph();
//	cout << "i am alive"<< endl;
	context1.findAllLocalLoops();
//	cout << "i am alive"<< endl;
//	context1.printLocalLoops();
//	cout << "Now we start the buggy part"<< endl;
	context1.createLoopFormulae();



//	context1.printLocalLoops();
	//	Context context2;
	//	context2.addRuleToKnowledgeBase(rule1);
	//	context2.addRuleToKnowledgeBase(rule2);
	...
	//	cout << "not equal" << endl;
	//	}
	cout << "ya RAB" << endl; // prints Hello World!!!
	return 0;
}
